package com.master.userservice.facade.impl;

import java.util.List;
import java.util.stream.Collectors;

import com.master.userservice.facade.Facade;
...
import com.master.userservice.sheard.exception.ValidationException;
import com.master.userservice.sheard.response.Response;
import com.master.userservice.sheard.response.ResponseStatus;
import com.master.userservice.sheard.validation.ValidationGroups;
...
public class FacadeImpl implements Facade {
    ...
    public Response<?> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        return new Response<>(com.master.userservice.sheard.response.ResponseStatus.BAD_REQUEST, errors);
    }
